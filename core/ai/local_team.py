...
class LocalAITeam:
    ...
    def __init__(
        ...
        self.workflow.add_step(WorkflowStep(name="research", role="researcher", task_template="{task}", required=True))
        self.workflow.add_step(WorkflowStep(name="code", role="coder", task_template="{task}", required=True))
        self.workflow.add_step(WorkflowStep(name="review", role="reviewer", task_template="Review: {previous_output}", required=True))
        self.workflow.add_step(WorkflowStep(name="analysis", role="analyst", task_template="Analyze: {previous_output}", required=True))
